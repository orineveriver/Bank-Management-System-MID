<?php
include("../control/adddmanagercashier_validation.php");
?> 
<!DOCTYPE html>
<html>
    <head>
    ...
    <a href="../view/dashboard.php">Dashboard</a><br>
        ...
        <form  action="" method="POST" >
                ...
                <input type="radio" name="type" id="manager" value="customer">
                <label for="type">Manager</label>
                <input type="radio" name="type" id="cashier" value="vendor">
