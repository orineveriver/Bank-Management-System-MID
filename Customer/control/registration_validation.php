<?php
            ...
            if($_SERVER['REQUEST_METHOD'] == "POST" && $_REQUEST['button'] == "Submit") {
                ...
                {
                    $nniderr = "Please enter your Nominee NID number!";
                }
                ...
                else if($_POST['cpass']!=$_POST['pass'])
                {
                    ...
                    if($notavailable == "")      
                        {
                            $details = array('firstname' => $firstname, 'lastname' => $lastname, 'nid' => $nid, 'dob' => $dob, 'gender' => $gender, 'email' => $email, 'phone' => $phone, 'nnid' => $nnid, 'type' => $type, 'accno' => $accno) ;
                            ...
                            $usertable = array('username' => $email, 'accno' => $accno, 'type' => $type, 'balance' => '0');
                            $usertable_encoded = json_encode($usertable);

                            $log_filepath = "../database/balancetable.txt";
